...
# Quickly jump right after the first word
...
# Quickly jump right after the second word
function _after-second-word() {
    zle beginning-of-line
    zle forward-word
    zle forward-word
}
zle -N _after-second-word
bindkey '\C-X2' _after-second-word
